...
@IBDesignable open class RangeSlider: UIControl {
  ...
  open func updateLabelText() {
    ...
    lowerLabelTextSize = (lowerLabel.string as! NSString).size(attributes: [NSAttributedString.font : UIFont.systemFont(ofSize: labelFontSize)])
    upperLabelTextSize = (upperLabel.string as! NSString).size(attributes: [NSAttributedString.font : UIFont.systemFont(ofSize: labelFontSize)])
  }
